//
//  PersonByNameFetchResultController.swift
//  ProjetSwift
//
...
class PersonByNameFetchResultController: NSObject, NSFetchedResultsControllerDelegate{
    
        let firstname : String
        let lastname : String
        //let tableView  : UITableView
    
        init(newfirstname: String, newlastname: String){
            //self.tableView  = view
        ...
        lazy var personsFetched : NSFetchedResultsController<Person> = {
            ...
            request.predicate = NSPredicate(format: "pfirstname == %@ and plastname == %@ ", self.firstname, self.lastname)
